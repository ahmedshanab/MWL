                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="card" style="width: 18rem;">
                                 ...
                                 @else 
                                 <img height="150" width="180" src="/images/default.jpeg" class="card-img-top" alt="Course Photo">
                                 @endif
                                 <div class="card-body">
                                ...
                                <input class="btn btn-danger btn-sm" type="submit" value="Delete" name="Delete" name="deletecourse">
